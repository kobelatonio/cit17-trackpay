...
@section('addbtn')
<a class="add" href="/admin/leave_applications/create">Add a leave application</a>
@endsection
	...
	<table style="width: 100%">
		...
		<tbody>
			...
			<tr>
				...
				<td class="settings"> 
					<a class="edit" href="/admin/leave_applications/{{ $leave_application->id }}/edit">Edit</a>
					<a class="show" href="/admin/leave_applications/{{ $leave_application->id }}">Show</a>
					<form method='POST' action='/admin/leave_applications/{{ $leave_application->id }}'>
						@method('DELETE')
						@csrf
